...
(function ($) {
    ...
    jqueryguide.fn = jqueryguide.prototype = {
        ...
        showBubble: function (elm, bubbleParam) {
            ...
            var $bubble = $('<div class="jguidebubble" data-bubbles="' + i + '"><div>' + bubbleParam.header + '</div><div class="jguidecontent">' + bubbleParam.content + '</div><div class="arrow"></div></div>').appendTo("body");
